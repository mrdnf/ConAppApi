const Operation = require('../../models/sell/Ops-sell-cash');
...
exports.getOperations =  asyncHandler(async (req, res, next) => {
    ...
    let query = {ops: "sell", paymentType: "cash" };
...
let payload = {
    ...
    accounting    : [
                        {   id: req.body.cash,
                            ...
                            details: `sell cash ${req.body.quantity} ${unitx} Of ${productx.name}  from ${storex.name} store`
                        },
