const Operation = require('../../models/buy/Ops-buy-cash');
...
exports.getOperations =  asyncHandler(async (req, res, next) => {
    ...
    let query = {ops: "buy", paymentType: "cash"};
...
[ 
    {  id: req.body.cash,
        ...
        credit: 0,
        details: `buy cash ${req.body.quantity} ${unitx} Of ${productx.name} from ${supplierx.name}`  },

    { id: req.body.supplier,
        debit: req.body.total,
        credit: 0,
        details: `payment cash to buy ${req.body.quantity} ${unitx}  Of ${productx.name}` },

    { id: req.body.supplier,
        debit: 0,
        credit: req.body.total,
        details: `buy cash ${req.body.quantity} ${unitx}  Of ${productx.name}` } 
]
...
let payload = {
    ...
    accounting    : [
                        {   id: req.body.cash,
                            ...
                            credit: 0,
                            details: `buy cash ${req.body.quantity} ${unitx} Of ${productx.name} from ${supplierx.name}  in ${storex.name} store`
                        },
